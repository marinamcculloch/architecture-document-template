...
====
ClientApi: The api consumed by end-users/customers, for example via the mobile apps
====

*Storage*

The Tickle clientApi 
...
- Google Cloud Storage bucket  tickle-<env>-clientapi-storage-euw2-deployments

- Swagger documentation

- Consumable API Gateway URL i.e. https://tickle-dev-clientapi-apigw-gateway-c9k1ab77.nw.gateway.dev/swagger-ui/index.ht

====
AdminApi: The api consumed by Tickle admin and brands, for example via the brand portal
====
...
====
Core: Components that manage the underlying system and data used by the api Additionally, this repo contains the Web Terraform module which deploys the infrastructure to host the front-end projects
====
